...
$search_query = "SELECT * FROM `products` WHERE category_id = 2";
...
<body>
    ...
    <form method="GET" action="" class="filter-form">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" name="price" class="form-control filter-box" placeholder="e.g: 200-500"

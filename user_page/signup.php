...
class Signup {
    ...
    public function saveToDatabase() {
        if ($this->valid) {
            ...
            $sql = "INSERT INTO `users` (`email`, `password`, `first_name`, `second_name`, `last_name`, `phone`, `address`) 
                    VALUES ('$this->email', '$hashedPassword', '$this->first_name', '$this->second_name', '$this->last_name', '$this->phone', '$this->address')";
    ...
    <div class="container">
        ...
        <form method="post" onsubmit="return signvalid(event)">
            ...
            <div style="text-align: center;">
                ...
                <p>Already have an account? <a href="login.html">Login page</a></p>
            </div>
        </form>
    </div>
